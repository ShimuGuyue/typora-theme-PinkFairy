...
+ 2026-02-23（V4.0）：修改标题前后缀修饰样式。
+ 2026-03-01（V4.1）：微调列表符号位置；引用块字号缩小。
+ 2026-03-10（V4.2）：引用块调整默认字体颜色为灰色；引用块内粗体和斜体均调整为小字号。
+ 2026-04-02（V4.3）：代码块字号缩小；取消代码块圆角样式；修改代码块内外边距。
+ 2026-04-12（V4.4）：修正无序列表和有序列表交错使用时内层标识符渲染错误的问题。
